...
errorbar(T,mean(RevRates,2),2*std(RevRates'),'o')
hold on, plot(T,mean(RevRates,2),'.','MarkerSize',20)
set(gcf,'Color','w')
set(gca,'FontSize',16)
box off
xlabel('Average time in Myr')
...
hold on, plot([T(1) T(end)],[rr rr],'--','LineWidth',2)
