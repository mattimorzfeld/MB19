function TrianglePlot(samples,numbins)
%% .........................................................................
...
for kk = 1:m
    if kk>1
        for ll = 1:kk-1
            subplot(m,m,ll+(kk-1)*m)
            ndhist(samples(ll,:),samples(kk,:),'filter','bins',numbins);
            set(gca,'FontSize',16)
        end
    end
    subplot(m,m,kk+(kk-1)*m)
    [x, bins]=myhist(samples(kk,:),20);
%     stairs(x,bins,'k','LineWidth',1.5);
    stairs(x,bins,'Color',Color(:,2),'LineWidth',1.5);
    set(gca,'FontSize',16)
    box off
